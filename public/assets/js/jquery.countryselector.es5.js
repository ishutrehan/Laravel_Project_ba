            ...
            return this.each(function () {
                ...
                if (!_showFlag) {
                    ...
                    $.each(_countries, function (i, country) {
                        $("<option value=\"" + country[_codeProp] + "\">" + country[NAME] + "</option>").data("country", country).appendTo(_$this);
                    });
                    _$this.val(_initValue);
                } else {
                    var _$selector, _$list;

                    (function () {
                        var ensureVisible = function ensureVisible($li) {
                        ...
                        var select = function select($li) {
                            var country = $li.data("country");
                            _$selector.find("span.cs-flag-selected").removeClass().addClass("cs-flag-selected cs-flag " + country[ALPHA3_CODE]);
                            _$selector.find("span.cs-name-selected").text(country[NAME]);
                        ...
                        var showList = function showList() {
                            ...
                            _$list.css({ left: left + "px", top: top + "px" }).show();
                        };

                        var setValue = function setValue(code) {
                            _$list.children("li").each(function () {
                                var $li = $(this),
                                    country = $li.data("country"),
                        ...
                        _$selector = $("<div class=\"cs-selector\" tabindex=\"0\"><span class=\"cs-flag-selected cs-flag XXX\"></span><span class=\"cs-name-selected\"></span><span class=\"cs-arrow\"></span></div>").insertAfter(_$this);
                        _$list = $("<ul class=\"cs-list\" style=\"display: none;\"></ul>").insertAfter(_$selector);

                        _$selector.on("focus click", showList).blur(function () {
                        ...
                        $.each(_countries, function (i, country) {
                            $("<li><span class=\"cs-flag " + country[ALPHA3_CODE] + "\"></span>" + country[NAME] + "</li>").data("country", country).appendTo(_$list);
                        });
